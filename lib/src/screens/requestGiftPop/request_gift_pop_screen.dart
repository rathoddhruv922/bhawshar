...
class RequestGiftPop extends StatefulWidget {
  const RequestGiftPop({super.key});

  @override
  State<RequestGiftPop> createState() => _RequestGiftPopState();
}

class _RequestGiftPopState extends State<RequestGiftPop> {
  Timer? debounce;
      ...
      if (searchProductController.text.trim() != '') {
        BlocProvider.of<ProductBloc>(context).add(
          SearchProductEvent(
            ...
            type:
                requestItem == 'Gift Article' ? 'gift article' : 'pop material',
                    ...
                    decoration: InputDecoration(
                      suffixIcon: IconButton(
                        onPressed: () async {
                          ...
                          } else if (editQty.text.trim() != '' &&
                              int.parse(editQty.text) <= 0) {
            ...
            ListTile(
              ...
              title: Padding(
                ...
                child: AppTextField(
                  ...
                  hintText: reqItemType == 'Gift Article'
                      ? localization.gift_search
                      : localization.pop_search,
                  labelText: reqItemType == 'Gift Article'
                      ? localization.gift_search
                      : localization.pop_search,
                  onTap: () async {
                  ...
                  onFieldSubmit: (value) async {
                    if (value != '') {
                      BlocProvider.of<ProductBloc>(context).add(
                        SearchProductEvent(
                          searchKeyword:
                              searchProductController.text.toString(),
                          type: reqItemType == 'Gift Article'
                              ? 'gift article'
                              : 'pop material',
                          existingProductIds: existingProductIds,
                                                                      ...
                                                                      if (generalController[index]
                                                                        ...
                                                                        myToastMsg(
                                                                            ...
                                                                            gravity:
                                                                              ...
                                                                              '' &&
                                                                          int.parse(generalController[index].text) <=
                                                                              0) {
                                                                        myToastMsg(
                                                                            localization
                                                                                .quantity_invalid,
                                                                        ...
                                                                        productItems
                                                                          ...
                                                                          "name": products
                                                                              ...
                                                                              .name,
                                                                          "qty":
                                                                              generalController[index].text
                                                                        });
                                                                        existingProductIds.add(products?.items?[index].id ??
                                                                            -1);
                      ...
                      child: Padding(
                        ...
                        child: AppButtonWithLocation(
                          ...
                          onBtnClick: () async {
                            ...
                            var clientId = user['mr_client_id'].toString();
                            var distributorId = user['sm_client_id'].toString();
